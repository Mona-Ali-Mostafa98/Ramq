...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="text-center">
            <a href="{{ route('admin.codes.create') }}" class="mt-4 btn btn-success">Create Discount Codes</a>
        </div>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Discount Codes Table</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Discount Codes Table</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        @foreach ($codes as $code)
                                            <tr>
                                                ...
                                                <td class="row">
                                                    <a href="{{ route('admin.codes.show', $code->id) }}"
                                                    ...
                                                    <form class="col-2" method="post"
                                                        action="{{ route('admin.codes.destroy', $code->id) }}">
                                                        @csrf
                                                        @method ('delete')
